                   ...
                   <form name="frm" action="" method="get">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <?php if(isset($_GET['s'])) { ?>
                          <a href="{{ route('all-mentor') }}" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-remove"></span></a>
                        <?php } ?>
                      </div>
                      </div>
                    </div>
                      ...
                      if(!empty($mentors) && count($mentors) > 0)
                      {
                        ...
                        foreach($mentors as $v)
                        {
                          ...
                          <tr>
                            ...
                            <td>
                              <select class="ckb_isfront form-control" name="mentors" id="isfront<?php echo $v->ID; ?>" data="<?php echo $v->ID; ?>" <?php if($v->is_show_front == 1) { ?> style="border-color: green;" <?php } ?>>
                            ...
                            <td>
                              <a href="{{ route('add-mentor') }}/{{ $v->ID }}" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-edit"></span></a>
                              <a href="{{ route('del-mentor') }}/{{ $v->ID }}" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo _tr('Sure To Delete This Mentor ?'); ?>');"><span class="glyphicon glyphicon-remove"></span></a>
                            </td>
                          </tr>
                          <?php
                          $sl++;
