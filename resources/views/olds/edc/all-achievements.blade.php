...
@section('title')
<div class="col-lg-12">
    <h1 class="page-header">All Achievements</h1>
</div>
@stop
@section('dashboard')
          <div class="row">
                      ...
                      if(!empty($all_achievements) && count($all_achievements) > 0)
                      {
                        ...
                        foreach($all_achievements as $k=>$v)
                        {
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{ route('edc-add-achievements') }}/{{ $v->ID }}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-edit"></span></a>
                              <a href="{{ route('edc-delete-achievements') }}/{{ $v->ID }}" class="btn btn-danger btn-xs" onclick="return confirm('Sure To Delete This Achievement ?');"><span class="glyphicon glyphicon-remove"></span></a>
                            </td>
                          </tr>
                          <?php
                          $sl++;
