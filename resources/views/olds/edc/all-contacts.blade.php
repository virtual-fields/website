                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      ...
                      <?php if(isset($_GET['s']) || isset($_GET['status'])) { ?>
                        <a href="{{ route('edc-all-contacts') }}" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-remove"></span></a>
                      <?php } ?>
                    </div>
                  </div>
                  </form>
                    ...
                    <div class="col-md-12">
                     <table class="table table-bordered table-striped ar-table"> 
                      ...
                      <tbody>
                        ...
                        if(!empty($all_contacts) && count($all_contacts) > 0)
                        {
                          ...
                          foreach($all_contacts as $k=>$v)
                          {
                            ...
                            <tr>
                              ...
                              <td>
                                <select class="ajx_status form-control" name="contact" id="status<?php echo $v->ID; ?>" data="<?php echo $v->ID; ?>" <?php if($v->status == 0) { ?> style="border-color: red;" <?php } ?>>
                              ...
                              <td>
                                <a href="{{ route('edc-add-contact') }}/{{ $v->ID }}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-edit"></span></a>
                                <a href="{{ route('edc-delete-contact') }}/{{ $v->ID }}" class="btn btn-danger btn-xs" onclick="return confirm('Sure To Delete This Contact ?');"><span class="glyphicon glyphicon-remove"></span></a>
                              </td>
                            </tr>
                            <?php
                            $sl++;
                        ...
                        {
                          echo "<tr><td colspan='5' style='text-align:center;'>No Contacts Found.</td></tr>";
                        }
                        ?>
                      </tbody>
                     </table>
