...
@section('title')
<div class="col-lg-12">
    <h1 class="page-header">All Stories</h1>
</div>
@stop
@section('dashboard')
          <div class="row">
                      ...
                      if(!empty($all_success_stories) && count($all_success_stories) > 0)
                      {
                        ...
                        foreach($all_success_stories as $k=>$v)
                        {
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{ route('edc-add-success-stories') }}/{{ $v->ID }}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-edit"></span></a>
                              <a href="{{ route('edc-delete-success-stories') }}/{{ $v->ID }}" class="btn btn-danger btn-xs" onclick="return confirm('Sure To Delete This Story ?');"><span class="glyphicon glyphicon-remove"></span></a>
                            </td>
                          </tr>
                          <?php
                          $sl++;
