                   ...
                   <div class="row">
                      ...
                      <div class="col-md-2">
                        ...
                        <?php if(isset($_GET['status']) || isset($_GET['s'])) { ?>
                          <a href="{{ route('edc-all-activity') }}" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-remove"></span></a>
                        <?php } ?>
                      </div>
                   </div>
                  </form>
                        ...
                        if(!empty($all_activity) && count($all_activity) > 0)
                        {
                          ...
                          foreach($all_activity as $k=>$v)
                          {
                            ...
                            <tr>
                              ...
                              <td><?php echo date('d-m-Y', strtotime($v->from_date)); ?></td>
                              ...
                              <td>
                                <a href="{{ route('edc-add-activity') }}/{{ $v->ID }}" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-edit"></span></a>
                                <a href="{{ route('edc-delete-activity') }}/{{ $v->ID }}" class="btn btn-danger btn-xs" onclick="return confirm('Sure To Delete This Activity ?');"><span class="glyphicon glyphicon-remove"></span></a>
                              </td>
                            </tr>
                            <?php
                            $sl++;
