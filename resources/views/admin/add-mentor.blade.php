...
@section('dashboard')
      ...
      <div class="panel-heading">
		<h3 class="panel-title"><?php if(!empty($single_mentor)) echo "Edit Mentor";  else echo "Add New Mentor"; ?>
        </h3>
</div>
<div class="panel-body">
                <form name="frm" action="<?php if(!empty($single_mentor)) { ?> {{ route('update-mentor') }} <?php } else { ?> {{ route('save-mentor') }} <?php } ?>" method="post" enctype='multipart/form-data'>
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <span style="color:RED;" class="err_msg"><small>{{$errors->first('salutation')}}</small></span>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <span style="color:RED;" class="err_msg"><small>{{$errors->first('first_name')}}</small></span>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <span style="color:RED;" class="err_msg"><small>{{$errors->first('last_name')}}</small></span>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="is_show_front" id="is_show_front">
                            <option value="0" <?php if(!empty($single_mentor) && $single_mentor->is_show_front == 0) { ?> selected="selected" <?php } ?>>NO</option>
                            <option value="1" <?php if(!empty($single_mentor) && $single_mentor->is_show_front == 1) { ?> selected="selected" <?php } ?>>YES</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="is_edc_id" id="is_edc_id">
                            ...
                            if(!empty($getAllEdcs))
                            {
                                ...
                                {
                                    ?>
                                    <option value="<?php echo $v; ?>" <?php if(!empty($single_mentor) && $single_mentor->is_edc_id == $v) { ?> selected="selected" <?php } ?>><?php echo $k; ?></option>
                                    <?php
                                }
                            }
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="submit" name="update_mentor" value="Save Mentor" class="btn btn-primary btn-sm-block">
                        ...
                        <a href="{{ route('all-mentor') }}" class="btn btn-primary btn-sm-block">All Mentors</a>
                        <?php } else { ?>
                        <input type="submit" name="create_mentor" value="Create Mentor" class="btn btn-primary btn-sm-block">
                        <?php } ?>
                    </div>
